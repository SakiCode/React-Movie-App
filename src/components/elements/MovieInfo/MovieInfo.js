...
const MovieInfo = ({ movie, directors }) => (
  <div className="rmdb-movieinfo"
    style={{
      background: movie.backdrop_path ? `linear-gradient(to right, rgb(14, 27, 97, 0.6) 40%, rgba(0, 0, 0, 0.4) 100%), url('${IMAGE_BASE_URL}${BACKDROP_SIZE}${movie.backdrop_path}')` : '#000'
    }}
  >
